          ...
          <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="boxcar-title">
              <ul class="breadcrumb">
                ...
                <li><span><?php echo t('services.mechanical_repairs'); ?></span></li>
              </ul>
              <h2><?php echo t('repair.title'); ?></h2>
              <div class="text"><?php echo t('repair.subtitle'); ?></div>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="content-box">
              <div class="text"><?php echo t('repair.intro_text_1'); ?></div>
              <div class="text"><?php echo t('repair.intro_text_2'); ?></div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="exp-block col-md-2 col-sm-12">
            <div class="inner-box">
              <div class="exp-box">
                ...
                <div class="text"><?php echo t('repair.years_experience'); ?></div>
              </div>
              <div class="image-box">
    ...
    <div class="boxcar-container">
      <div class="right-box">
        <div class="boxcar-title wow fadeInUp animated">
          <h2><?php echo t('repair.our_services'); ?></h2>
        </div>
        <div class="row">
          <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInUp">
              <div class="icon-box">
                <i class="fas fa-engine fa-3x" style="color: #405FF2;"></i>
              </div>
              <div class="content-box">
                <h6 class="title"><?php echo t('repair.engine_repair'); ?></h6>
                <div class="text"><?php echo t('repair.engine_repair_text'); ?></div>
              </div>
            </div>
          </div>
          ...
          <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInUp" data-wow-delay="100ms">
              <div class="icon-box">
                <i class="fas fa-car-gear fa-3x" style="color: #405FF2;"></i>
              </div>
              <div class="content-box">
                <h6 class="title"><?php echo t('repair.transmission_repair'); ?></h6>
                <div class="text"><?php echo t('repair.transmission_repair_text'); ?></div>
              </div>
            </div>
          </div>
          ...
          <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInUp" data-wow-delay="200ms">
              <div class="icon-box">
                <i class="fas fa-car-crash fa-3x" style="color: #405FF2;"></i>
              </div>
              <div class="content-box">
                <h6 class="title"><?php echo t('repair.brake_repair'); ?></h6>
                <div class="text"><?php echo t('repair.brake_repair_text'); ?></div>
              </div>
            </div>
          </div>
          ...
          <div class="choose-us-block col-lg-3 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInUp" data-wow-delay="300ms">
              ...
              <div class="content-box">
                <h6 class="title"><?php echo t('repair.electrical_repair'); ?></h6>
                <div class="text"><?php echo t('repair.electrical_repair_text'); ?></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="faq-column wow fadeInUp" data-wow-delay="400ms">
          <div class="inner-column">
            <div class="boxcar-title text-center">
              <h2 class="title"><?php echo t('repair.faq_title'); ?></h2>
            </div>
            <ul class="widget-accordion wow fadeInUp">
              <!--Block-->
              <li class="accordion block active-block">
                <div class="acc-btn active"><?php echo t('repair.faq_cost'); ?>
                  <div class="icon fa fa-plus"></div>
                </div>
                <div class="acc-content current">
                  <div class="content">
                    <div class="text"><?php echo t('repair.faq_cost_answer'); ?></div>
                  </div>
                </div>
              </li>
              ...
              <li class="accordion block">
                <div class="acc-btn"><?php echo t('repair.faq_duration'); ?>
                  <div class="icon fa fa-plus"></div>
                </div>
                <div class="acc-content">
                  <div class="content">
                    <div class="text"><?php echo t('repair.faq_duration_answer'); ?></div>
                  </div>
                </div>
              </li>
              ...
              <!--Block-->
              <li class="accordion block">
                <div class="acc-btn"><?php echo t('repair.faq_warranty'); ?>
                  <div class="icon fa fa-plus"></div>
                </div>
                <div class="acc-content">
                  <div class="content">
                    <div class="text"><?php echo t('repair.faq_warranty_answer'); ?></div>
                  </div>
                </div>
              </li>
              <!--Block-->
              <li class="accordion block">
                <div class="acc-btn"><?php echo t('repair.faq_parts'); ?><div class="icon fa fa-plus">
                  </div>
                </div>
                <div class="acc-content">
                  <div class="content">
                    <div class="text"><?php echo t('repair.faq_parts_answer'); ?>
                    </div>
                  </div>
                </div>
              </li>
