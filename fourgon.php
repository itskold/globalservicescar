    ...
    <div class="boxcar-container">
      <div class="boxcar-title-three wow fadeInUp">
        <ul class="breadcrumb">
          ...
          <li><span><?php echo t('services.van_rental'); ?></span></li>
        </ul>
        <h2><?php echo t('van.choose_your_van'); ?></h2>
      </div>
      <div class="row">

        <div class="col-xl-12 col-md-12 col-sm-12">
          <div class="text-box">
            <div class="text"><?php echo t('van.showing'); ?> 1 <?php echo t('van.to'); ?> <?= count($vehicles) ?>
              <?php echo t('van.of'); ?> <?= count($vehicles) ?> <?php echo t('van.vans'); ?></div>
            <form>
              <div class="form_boxes v3">
                <small><?php echo t('van.sort_by'); ?></small>
                <div class="drop-menu height-auto">
                  <div class="select">
                    <span><?php echo t('van.all_brands'); ?></span>
                    <i class="fa fa-angle-down"></i>
                  </div>
                  <input type="hidden" name="make">
                  <ul class="dropdown" style="display: none;">
                    <?php foreach ($vehicles as $vehicle) : ?>
                      <?php if ($vehicle['type'] === 'FOURGON') : ?>
                ...
                <div class="car-block-four col-lg-4 col-md-6 col-sm-12">
                  <div class="inner-box">
                    ...
                    <div class="content-box">
                      ...
                      <div class="btn-box">
                        <small><?= $vehicle['prix'] ?></small><sup>/<?php echo t('van.day'); ?></sup>
                        <a href="/car-detail.php?id=<?= $vehicle['id'] ?>" class="details"><?php echo t('van.choose'); ?>
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <ul class="pagination">
                <li class="page-item">
                  <a class="page-link" href="#" aria-label="Previous">
                    ...
                    <span class="sr-only"><?php echo t('van.previous'); ?></span>
                  </a>
                </li>
                ...
                <li class="page-item">
                  <a class="page-link" href="#" aria-label="Next">
                    ...
                    <span class="sr-only"><?php echo t('van.next'); ?></span>
                  </a>
                </li>
              </ul>
              <div class="text"><?php echo t('van.showing'); ?> 1 <?php echo t('van.to'); ?> <?= count($vehicles) ?>
