        ...
        <div class="boxcar-container">
            <div class="boxcar-title-three wow fadeInUp">
                <ul class="breadcrumb">
                    ...
                    <li><span><?php echo t('services.view_rentals'); ?></span></li>
                </ul>
                <h2><?php echo t('car.choose_your_vehicle'); ?></h2>
            </div>
            <div class="row">

                <div class="col-xl-12 col-md-12 col-sm-12">
                    <div class="text-box">
                        <div class="text"><?php echo t('car.showing'); ?> 1 <?php echo t('car.to'); ?> <?= count($vehicles) ?>
                            <?php echo t('car.of'); ?> <?= count($vehicles) ?> <?php echo t('car.vehicles'); ?></div>
                        <form>
                            <div class="form_boxes v3">
                                <small><?php echo t('car.sort_by'); ?></small>
                                <div class="drop-menu height-auto">
                                    <div class="select">
                                        <span><?php echo t('car.all_brands'); ?></span>
                            ...
                            <div class="car-block-four col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-box">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <div class="btn-box">
                                            <small><?= $vehicle['prix'] ?></small><sup>/<?php echo t('car.day'); ?></sup>
                                            <a href="/car-detail.php?id=<?= $vehicle['id'] ?>" class="details"><?php echo t('car.choose'); ?>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="pagination">
                                <li class="page-item">
                                    <a class="page-link" href="#" aria-label="Previous">
                                        ...
                                        <span class="sr-only"><?php echo t('car.previous'); ?></span>
                                    </a>
                                </li>
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="#" aria-label="Next">
                                        ...
                                        <span class="sr-only"><?php echo t('car.next'); ?></span>
                                    </a>
                                </li>
                            </ul>
                            <div class="text"><?php echo t('car.showing'); ?> 1 <?php echo t('car.to'); ?> <?= count($vehicles) ?>
